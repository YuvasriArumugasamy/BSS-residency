...
const FAQ_DATA = [
  ...
  // Location & Transport
  {
    ...
    q: 'How far is SM Golden Resorts from the Courtallam Bus Stand?',
  ...
  // Food & Services
  {
    ...
    a: 'SM Golden Resorts does not have an in-house restaurant. However, several good hotels and restaurants are within 50–100 metres — including Saravana Bhavan, local mess, and juice shops.',
  },
  {
  ...
  },
  {
    ...
    q: 'Are pets allowed?',
    a: 'We are sorry, pets are not allowed at SM Golden Resorts at this time.',
  },
  {
...
export default function FAQ() {
  ...
  return (
    <>
      <SEO
        title="FAQ | SM Golden Resorts Courtallam — Frequently Asked Questions"
        description="Get answers to common questions about SM Golden Resorts Courtallam — check-in time, parking, waterfalls distance, room facilities, booking process and more."
        keywords="sm golden resorts faq, courtallam hotel questions, courtallam lodge check in time, courtallam waterfalls distance, hotel near courtallam faq, kutralam hotel booking questions"
      ...
      <main className="faq-page">
        ...
        <section className="page-hero faq-hero">
          ...
          <p>Everything you need to know about your stay at SM Golden Resorts</p>
        ...
        <section className="faq-cta">
          <div className="faq-cta-inner container">
            ...
            <div className="faq-cta-btns">
              <a
                href={waLink('Hello SM Golden Resorts! I have a question about my stay.')}
                className="btn-gold"
                target="_blank"
                rel="noreferrer"
              >
